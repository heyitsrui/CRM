  ...
  // 1. Import your Signup component correctly
  import CreateAccount from './pages/create-account'; 

  // 2. This is your actual Login UI content
      ...
      <div className="content-wrapper">
        ...
        >
          ...
          <p className="signup-footer">
            {/* 3. Use the Link component for internal routing */}
  ...
  function App() {
    ...
    return (
      <Router>
        <Routes>
          {/* Route for Login (App.js main content) */}
          <Route path="/" element={
            <LoginView 
