...
const Proposal = () => {
  ...
  const handleEditClick = (p) => {
    setEditing(p);
    // FIX: Calculate Total Contract Value (Paid + Due) for the form amount
    const totalValue = (parseFloat(p.paid_amount) || 0) + (parseFloat(p.due_amount) || 0);
            ...
            >
              ...
              <div className="column-body">
                {projects
                  ...
                  .map((p) => {
                    // FIX: Calculate total for display on card if needed
                    const totalOnCard = (parseFloat(p.paid_amount) || 0) + (parseFloat(p.due_amount) || 0);
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="card-body">
                          ...
                          {/* Display the Total Contract Value on the card */}
                          <p className="amount">₱{Number(totalOnCard).toLocaleString()}</p>
